...
export default function LoginPage({ onLogin }: { onLogin: (user: User) => void }) {
  ...
  return <div className="login-shell">
    <section className="login-story">
      <div className="brand brand-light"><span className="brand-mark">S</span><span className="brand-copy"><strong>SKC Operaciones</strong><small>Procesos nativos</small></span></div>
