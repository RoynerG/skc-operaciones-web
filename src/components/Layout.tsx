...
export default function Layout({ user, onLogout, children }: { user: User; onLogout: () => void; children: ReactNode }) {
  ...
  return <div className={`app-frame ${collapsed ? 'nav-collapsed' : ''}`}>
    <aside className="app-sidebar">
      <div className="brand"><BrandLogo className="brand-logo-sidebar" /><span className="brand-copy"><strong>{branding.productName}</strong><small>Procesos nativos</small></span></div>
